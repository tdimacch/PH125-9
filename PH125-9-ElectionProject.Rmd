...
```{r installing_project_packages, warning = FALSE, message = FALSE,  echo = FALSE}
...
```{r installing_librarys, warning = FALSE, message = FALSE,  echo = FALSE}
...
```{r func_update_print_results, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r func_create_print_results, figures-side, fig.show="hold", out.with="100", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r func_draw_confusion_matrix, figures-side, fig.show="hold", out.with="100", echo = FALSE, message = FALSE, warning = FALSE}
...
```{r func_alpha_n_bootstrap, echo=FALSE}
...
```{r project_clean_up, warning = FALSE, message = FALSE,  echo = FALSE}   
...
```{r project_start_up, warning = FALSE, message = FALSE,  echo = FALSE }
...
```{r checking_required_files, warning = FALSE, message = FALSE,  echo = FALSE} 
...
```{r reading_datasets, warning = FALSE, message = FALSE,  echo = FALSE}
...
```{r data_wrangling_subsetting, warning = FALSE, message = FALSE,  echo = FALSE}
...
```{r creating_ratio_results,  out.width="50%", fig.align="default", fig.show="hold", fig.cap = "Train and Test Ratio Splits - Actual Results", warning = FALSE, message = FALSE,  echo = FALSE}
...
```{r create_ratio_actual_results,  out.width="50%", fig.align="default", fig.show="hold", warning = FALSE, message = FALSE,  echo = FALSE}
# Not used ... place holder
```

\newpage

```{r, create_datasets_train_test, warning = FALSE, message = FALSE,  echo = FALSE}
...
```{r print_correlation_matrix_summaries, out.width="70%", fig.align="centered", fig.cap = "Correlation Matrixes", echo=FALSE}
...
``` {r including_ml_algo, fig.cap="Machine Learning Algorithms", echo=FALSE, out.width='70%',fig.align="centered", fig.show="hold"}
...
``` {r including_model_comparison, fig.cap="Model Comparisons", echo=FALSE, out.width='60%', fig.align="centered", fig.show="hold"}
...
```{r cart_model, echo = FALSE, message = FALSE, warning = FALSE, eval = TRUE}
# Classification Tree Model - Classification and Regression Tree (CART)
...
```{r plotting_decision_trees, out.width="80%", fig.align="centered", fig.show="hold", fig.cap="Decision Tree", fig.show="hold", echo = FALSE, message = FALSE, warning = FALSE}
...
```{r create_CART_CM, fig.cap="Confustion Matrix - CART", fig.show="hold", out.width="100%", fig.align="centered", fig.show="hold", echo = FALSE, message = FALSE, warning = FALSE}
func_draw_confusion_matrix(test_confusion, cart1predtuned, model_name) 
func_update_print_results(test_confusion, model_name)
```


```{r results_cart, out.width="50%", fig.align="centered", fig.show="hold", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r random_forest_model, fig.cap="Confusion Matrix - RFM", out.width="100%", fig.align="centered", fig.show="hold",echo=FALSE}
...
```{r results_rfm, out.width="50%", fig.align="centered", fig.show="hold", echo=FALSE, message=FALSE, warning=FALSE}
# trying to foce knit pdf to be the correct order.  
func_create_print_results(test_confusion, model_name, TRUE)  
```
...
```{r naive_bayes_model, fig.cap="Confusion Matrix - Naive Bayes", out.width="100%", fig.align="centered", fig.show="hold", echo=FALSE}
# Conditional Probablity Model - Naive Bayes (NB)
...
```{r results_nb, out.width="50%", fig.align="centered", fig.show="hold", echo=FALSE, message=FALSE, warning=FALSE}
# trying to foce knit pdf to be the correct order.  
func_create_print_results(test_confusion, model_name, TRUE)  
```
...
```{r simple_logistic_regression_model_stepAIC, fig.cap="Confusion Matrix - LRM", out.width="100%", fig.align="centered", fig.show="hold", warning = FALSE, message = FALSE,  echo = FALSE}            
...
```{r results_step, out.width="50%", fig.align="centered", fig.show="hold", echo=FALSE, message=FALSE, warning=FALSE}
# trying to foce knit pdf to be the correct order.  
func_create_print_results(test_confusion, model_name, TRUE)  
```
...
```{r binary_logistic_regression_blr, fig.cap="Confusion Matrix - BLR", out.width="100%", fig.align="centered", fig.show="hold", echo = FALSE, message = FALSE, warning = FALSE,}
# Logistic Regression (BLR) - Binary
...
```{r results_blr, out.width="50%", fig.align="centered", fig.show="hold", echo=FALSE, message=FALSE, warning=FALSE}
# trying to foce knit pdf to be the correct order.  
func_create_print_results(test_confusion, model_name, TRUE)  
```
...
```{r LDA_Model, fig.cap="Confusion Matrix - LDA", out.width="100%", fig.align="centered", fig.show="hold", echo = FALSE, message = FALSE, warning = FALSE}
# Logistic Regression - Latent Dirichlet Allocation (LDA)
...
```{r results_lda, out.width="50%", fig.align="centered", fig.show="hold", echo=FALSE, message=FALSE, warning=FALSE}
# trying to foce knit pdf to be the correct order.  
func_create_print_results(test_confusion, model_name, TRUE)  
```
...
```{r quadratic_discriminant_model, out.width="100%", fig.align="centered", fig.show="hold", fig.cap="Confusion Matrix - QDA", echo = FALSE, message = FALSE, warning = FALSE}
# Logistic Regression -  Quadratic Discrimination Analysis (QDA)
...
```{r results_qda, out.width="50%", fig.align="centered", fig.show="hold", echo=FALSE, message=FALSE, warning=FALSE}
# trying to foce knit pdf to be the correct order.  
func_create_print_results(test_confusion, model_name, TRUE)  
```
...
```{r  tuned_models, out.width="50%", fig.align="centered", fig.show="hold", fig.cap="Confusion Matrix - Tuned Models", warning = FALSE, message = FALSE,  echo = FALSE}
...
```{r results_tuned, out.width="50%", fig.align="centered", fig.show="hold", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r cv_leave_one_out_tuning, out.width="100%", fig.align="centered", fig.show="hold", fig.cap="Confusion Matrix - X-VAL - Leave-One-Out", echo=FALSE, message=FALSE, warning=FALSE}
# Model Resampling: Cross-Validatioan - Leave-One-Out
...
```{r print_leave_one_out_results, out.width="100%", fig.align="centered", fig.show="hold", echo=FALSE, message=FALSE, warning=FALSE}
func_create_print_results(test_confusion_cv, model_name, FALSE) 
```

\newpage

```{r print_final_model_summary, out.width="100%", fig.align="centered", fig.show="hold", fig.cap="Results - X-VAL - Leave-One-Out", warning = FALSE, message = FALSE,  echo = FALSE}
...
```{r cv_kfold_tuning, out.width="100%", fig.align="centered", fig.show="hold", fig.cap="Confusion Matrix - X-VAL - k-Fold", echo=FALSE, message=FALSE, warning=FALSE}
# Model Resampling: K-Fold
...
```{r print_kfold_results, out.width="50%", fig.align="centered", fig.show="hold", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r disply_installed_packages, warning = FALSE, message = FALSE,  echo = FALSE}
(.packages())
```
...
```{r inspecting_train_dataset, echo=FALSE}
...
```{r inspecting_test_dataset, echo=FALSE}
...
```{r inspecting_train_subset_dataset, echo=FALSE}
...
```{r inspecting_test_subset_dataset, echo=FALSE}
...
```{r inspecting_train_sample_dataset, echo=FALSE}
...
```{r inspecting_test_sample_dataset, echo=FALSE}
...
```{r inspecting_train_sample_no_na_dataset, echo=FALSE}
...
```{r plot_SampleSize_ByParty, fig.show="hold", out.width="85%",  echo=FALSE}
...
```{r plot_by_gender, fig.show="hold", out.width="85%",  echo=FALSE}
...
```{r plot_by_income_bands, fig.show="hold", out.with="30%", echo=FALSE}
...
```{r plot_by_household_status, fig.show="hold", out.with="30%", echo=FALSE}
...
```{r plot_by_education_levels,  fig.show="hold", out.with="30%", echo=FALSE}
...
```{r plot_age_distribution, fig.show="hold", out.with="30%", echo = FALSE, message = FALSE, warning = FALSE, eval = TRUE}
...
```{r coorelaton_matrix_results, fig.show="hold", out.with="30%",warning = FALSE, message = FALSE,  echo = FALSE}
train_sample_num <- data.matrix(train_sample)
...
```{r corr_matrix_questions, fig.show="hold", out.with="30%",warning = FALSE, message = FALSE,  echo = FALSE}
corrplot(train_sample_questions_num_cor, type = "upper", order = "hclust", tl.col = "black")
...
```{r heatmaps,  fig.show="hold", out.with="40%", warning = FALSE, message = FALSE,  echo = FALSE}
...
## Appendix - G: Survey Questions
``` {r including_quesitons_1, out.width="80%", fig.align="default", fig.show="hold",fig.cap="Survey - Election Questions - Page 1", warning = FALSE, message = FALSE,  echo = FALSE}
...
``` {r including_quesitons_2, out.width="100%", fig.align="default", fig.show="hold", fig.cap="Survey - Election Questions - Page 2", warning = FALSE, message = FALSE,  echo = FALSE}
#\includepdf[pages=-]{./ElectionData/Questions.pdf}
#\captionof{figure}{"Survey - Election Questions"}
#\includepdf[pages=-]{./ElectionData/Questions.pdf}
#fig.cap="Survey - Election Questions"
...
```{r things_to_do_before_exiting, echo=FALSE, , message=FALSE, warning=FALSE}
